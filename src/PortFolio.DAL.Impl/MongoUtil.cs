...
namespace Portfolio.DAL.Impl
{
    ...
    internal static class MongoUtil
    {
        ...
        /// </summary>
        private const string DefaultConnectionstringName = "MongoServerUrl";
        ...
        public static IMongoCollection<T> GetCollectionFromConnectionString<T>(string connectionString)
            where T : IEntity
        {
            return MongoUtil.GetCollectionFromConnectionString<T>(connectionString, GetCollectionName<T>());
        }
        ...
        public static IMongoCollection<T> GetCollectionFromUrl<T>(MongoUrl url)
            where T : IEntity
        {
            return MongoUtil.GetCollectionFromUrl<T>(url, GetCollectionName<T>());
        }
